...
import { EstadoIssue } from "@myTypes/erp";
...
const DepartmentIssues: React.FC<DepartmentIssuesProps> = ({ depEnum }) => {
    ...
    <>
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[1000px] border rounded-lg bg-white-full shadow-sm">
          <div className="grid grid-cols-10 bg-gray-50 font-semibold text-gray-600 text-sm px-4 py-2 border-b">
            <div>ID</div>
            <div>Nombre</div>
          ...
          {issues && issues.length > 0 ? (
            issues.map((issue: any) => (
              <div
                key={issue.id}
                className="grid grid-cols-10 items-center px-4 py-3 border-b hover:bg-gray-50"
              >
